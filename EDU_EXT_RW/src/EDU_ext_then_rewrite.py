...
class SentExtractor:
    ...
    def _build_ext_args(self):
        ...
        parser.add_argument("-max_pos", default=512, type=int)
        parser.add_argument("-max_tgt_len", default=140, type=int)
        parser.add_argument("-max_n_tags", default=9, type=int)
        parser.add_argument("-use_interval", default=True, type=bool)
        parser.add_argument("-large", default=False, type=bool)
    ...
    def extract(self, batch):
        ...
        srctag = self.trainer.generate_srctag2(batch, sel_scores, sel_ids, self.decider)
        srcext = [ext[0] for ext in srcext]
        return srcext, srctag


class EDU_ext_then_rewrite:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-result_path", default='./results/EDU_ext_then_rewrite/')
    parser.add_argument("-log_file", default='./logs/EDU_ext_then_rewrite.log')
    ...
    abs = EDU_ext_then_rewrite('--The path of the EDUrewriter model', args.source_data_path, args.result_path)
    ...
    logger.info("==== Apply to disco_BERT-Ext extractor ====")
    sentext = SentExtractor('--The path of the EDUextractor model')
    abs.test_model(sentext, quick_test=args.quick_test)
